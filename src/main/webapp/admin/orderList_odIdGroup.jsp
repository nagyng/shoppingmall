...
<head>
<meta charset="UTF-8">
<title>주문 관리 페이지 / 주문 번호 & 주문 일자 같이 묶어서 보기 </title>
...
<!-- 관리자 모드 -->
	...
	<div class="container col-9 input-group">
		...
		<table class="table table-hover table-sm table-bordered"> <!--  table-striped -->
			...
			try{ 
					//모두보기
					  sql = "select 	min(o.od_id) as 'od_id'," +
				...
				%>
					<tr>
						...
						<td class="text-center">
							<input type="button" class="btn btn-warning btn-sm" value="수정" onclick="location.href='update_order_group.jsp?od_id=<%=od_id%>'">
						</td>
						<td class="text-center">
							<input type="button" class="btn btn-outline-danger btn-sm" value="삭제" onclick="location.href='delete_order_group.jsp?od_id=<%=od_id%>'">
						</td> --%>
