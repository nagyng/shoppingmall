	...
	<div class="container col-lg-6 col-md-12 col-sm-12">
		<div class="p-5">
			<div class="container-fluid">
				<h1 class="display-5 fw-bold text-center">회원 수정 (관리자용)</h1> 
			</div>
		</div>
		...
		<div class="container-fluid">
			<form name="joinForm" action="update_user_process.jsp" method="post" onsubmit="return joinForm()">	<!-- joinForm() -->
				...
				<div class="input-group input-group-lg mb-3">
					...
					<input value="<c:out value='${row.grade}'/>" name="grade" id="grade" type="text" class="form-control " aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" placeholder="grade">
				</div>
				<div class="input-group input-group-lg mb-3">
					<div class="input-group-prepend">
