	...
	<div class="container col-lg-6 col-md-12 col-sm-12">
		...
		<sql:query var="resultSet" dataSource="${conn}"> 
			SELECT 		o.od_id as 'od_id',
						...
						o.od_updatetime as 'od_updatetime',
						co.status as status
		...
		<c:forEach var="row" items="${resultSet.rows}"> 
				...
				<div class="input-group input-group-lg mb-3">
					<div class="input-group-prepend">
					  <label class="input-group-text  orderLabel" id="inputGroup-sizing-lg">품목 번호</label>
					</div>
				...
				<div class="input-group input-group-lg mb-3">
					<div class="input-group-prepend">
					  <label class="input-group-text  orderLabel" id="inputGroup-sizing-lg">수량</label>
					</div>
				...
				<div class="input-group input-group-lg mb-3">
					<div class="input-group-prepend">
					  <label class="input-group-text  orderLabel" id="inputGroup-sizing-lg">결제 금액</label>
					</div>
